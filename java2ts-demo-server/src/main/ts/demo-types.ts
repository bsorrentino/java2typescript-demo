...
interface TypescriptConverterStatic {
	...
	convertJavaToTS<M>( arg0:any /*java.lang.reflect.Type*/, arg1:M, arg2:org.bsc.java2typescript.TSType, arg3:java.util.Map<string, org.bsc.java2typescript.TSType>, arg4:boolean, arg5:java.util.Optional<Consumer<any /*java.lang.reflect.TypeVariable*/>> ):string;
	distinctByKey<T>( arg0:Func<T, any /*java.lang.Object*/> ):Predicate<T>;
	getParameterName( arg0:any /*java.lang.reflect.Parameter*/ ):string;
	isFunctionalInterface( arg0:java.lang.Class<any /*java.lang.Object*/> ):boolean;
	isStatic<M>( arg0:M ):boolean;
	processFunctionalInterface( arg0:org.bsc.java2typescript.TSType ):string;
}
